		...
		<main id="container" class="register_page login_page sub_container">
			<div class="contents">
				<div class="inner">
					<div class="logo_wrap">
						<h2 class="logo">
							<a href="/"></a> <span class="blind">팝콘로고</span>
						</h2>
					</div>
					<!-- 회원가입 폼 -->
					<div class="register_wrap">
						<form name="registerFrm" method="post" action="./normal.do"
							onsubmit="return validateForm(this);">
							<div class="input_wrap">
								<div class="item_id">아이디 :</div>
								<input type="text" name="id" class="input_id"
									placeholder="6-12자 이내의 아이디를 입력해주세요." autofocus="autofocus">
								<button type="button" class="check_btn" onclick="idCheck()">아이디
									중복 확인</button>
								<input type="hidden" name="idDuplication" value="idUnchecked" />
							</div>
							<div class="input_wrap">
								<div class="item_pass">비밀번호 :</div>
								<input type="password" name="pass" class="input_pass"
									placeholder="8자 이상의 비밀번호를 입력해주세요." autocomplete="off">
								<div class="item_pass2">비밀번호 확인 :</div>
								<input type="password" name="pass2" class="input_pass2"
									placeholder="비밀번호 확인을 위해 같은 비밀번호를 입력해주세요." autocomplete="off">
							</div>
							<div class="input_wrap">
							...
							<div class="input_wrap">
								...
								<input type="text" name="phone" class="input_phone"
									oninput="formatPhoneNumber(this)" placeholder="숫자만 입력해주세요.">
							</div>
							<div class="btn_wrap">
